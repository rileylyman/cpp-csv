...
void Data::setData(vector<string> data) { this->data = data; }
...
CSV::CSV() { StringUtils::msg_warning("Set Schema!"); }

CSV::CSV(string schema) { setSchema(schema); }
...
void CSV::insert_data(Data& data) { vec_data.push_back(data); }
...
vector<Data> CSV::lines() { return vec_data; }
